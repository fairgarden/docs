...
const TYPES_LOADER = '@fairgarden/docs/pipeline/loadPrecomputedTypes';
const SITEMAP_LOADER = '@fairgarden/docs/pipeline/loadPrecomputedSitemap';
const CODE_HIGHLIGHTER_LOADER = '@fairgarden/docs/pipeline/loadPrecomputedCodeHighlighter';
const TRANSFORM_METADATA_PLUGIN = '@fairgarden/docs/pipeline/transformMarkdownMetadata';
