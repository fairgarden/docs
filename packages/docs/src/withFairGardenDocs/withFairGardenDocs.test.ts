...
import { withFairGardenDocs, getFairGardenDocsMdxOptions } from './withFairGardenDocs';
...
const defaultUpdateParentIndex = {
  ...
  markerDir: '.next/cache/fairgarden-docs/types-index-updates',
  onlyUpdateIndexes: true,
  errorIfOutOfDate: Boolean(process.env.CI),
  cacheDir: '.next/cache/fairgarden-docs',
};

describe('withFairGardenDocs', () => {
  describe('basic configuration', () => {
    ...
    it('should allow disabling export output', () => {
      const plugin = withFairGardenDocs({ enableExportOutput: false });
      const result = plugin({});
    ...
    it('should add additional page extensions', () => {
      const plugin = withFairGardenDocs({ additionalPageExtensions: ['vue', 'svelte'] });
      const result = plugin({});
          ...
          loaders: [
            {
              ...
              options: { performance: {}, cacheDir: '.next/cache/fairgarden-docs' },
            },
          ],
        },
      });
  ...
  describe('performance options', () => {
    it('should pass performance options to turbopack loaders', () => {
      ...
      const plugin = withFairGardenDocs({ performance: performanceOptions });
      const result = plugin({});
      ...
      expect(result.turbopack?.rules).toEqual({
        ...
        './app/sitemap/index.ts': {
          loaders: [
            {
              loader: '@fairgarden/docs/pipeline/loadPrecomputedSitemap',
              options: { performance: performanceOptions, cacheDir: '.next/cache/fairgarden-docs' },
            },
          ],
        },
      });
    ...
    it('should handle undefined performance options gracefully', () => {
      const plugin = withFairGardenDocs(); // No performance options provided
      const result = plugin({});
  ...
  describe('emphasis options', () => {
    ...
    it('should pass codeBlockEmphasisOptions to turbopack types loader options', () => {
      ...
      const plugin = withFairGardenDocs({ codeBlockEmphasisOptions });
      const result = plugin({});
  ...
  describe('demo page generation', () => {
    ...
    it('marks the turbopack demo index rule with requirePage when requireDemoPage is set', () => {
      const plugin = withFairGardenDocs({ requireDemoPage: true });
      const result = plugin({});
  ...
  describe('ordering options', () => {
    ...
    it('should pass ordering to turbopack types loader options', () => {
      ...
      const plugin = withFairGardenDocs({ ordering });
      const result = plugin({});
...
describe('getFairGardenDocsMdxOptions', () => {
  it('should return default MDX options when no custom options provided', () => {
    const result = getFairGardenDocsMdxOptions({ errorIfIndexOutOfDate: false });
      ...
      [
        '@fairgarden/docs/pipeline/transformMarkdownMetadata',
        {
          extractToIndex: {
            ...
            baseDir: process.cwd(),
            cacheDir: '.next/cache/fairgarden-docs',
            markerDir: '.next/cache/fairgarden-docs/index-updates',
  ...
  it('should add additional plugins to defaults', () => {
    const result = getFairGardenDocsMdxOptions({
