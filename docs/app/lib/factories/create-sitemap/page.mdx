...
> [!TIP]
> Place your sitemap at `app/sitemap/index.ts` for automatic detection by [`withFairGardenDocs`](../../pipeline/with-fairgarden-docs/page.mdx).
...
```typescript
import { loadServerSitemap } from '@fairgarden/docs/pipeline/loadServerSitemap';
...
The webpack loader must be configured for the sitemap index file. See [`withFairGardenDocs`](../../pipeline/with-fairgarden-docs/page.mdx) or [`loadPrecomputedSitemap`](../../pipeline/load-precomputed-sitemap/page.mdx) for configuration details.
...
- [`withFairGardenDocs`](../../pipeline/with-fairgarden-docs/page.mdx) - Next.js plugin that configures the loader
