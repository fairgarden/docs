...
import { createDemoGlobalWithVariants } from '@fairgarden/docs/createDemoData';
...
import { createDemoFactory } from '@fairgarden/docs/abstractCreateDemo';
...
To make global demo data work properly, use [`withFairGardenDocs`](../../pipeline/with-fairgarden-docs/page.mdx) which automatically includes the demo-data patterns:
...
export default withFairGardenDocs({
  // withFairGardenDocs automatically includes:
  // - './app/**/demos/*/index.ts'
  // - './app/**/demos/*/client.ts'
