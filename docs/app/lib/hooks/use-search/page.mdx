...
```tsx
import { useSearch, defaultSearchBoost } from '@fairgarden/docs/useSearch';
...
- [`withFairGardenDocs`](../../pipeline/with-fairgarden-docs/page.mdx) - Next.js plugin that configures the build
