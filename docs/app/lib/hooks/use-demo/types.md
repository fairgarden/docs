...
[//]: types.ts '<-- Autogenerated By (do not edit the following markdown directly), run: pnpm docs:validate lib/hooks/use-demo'
...
| copyMarkdownRecentlySuccessful | `boolean`                                                                                                                        | Like `copyRecentlySuccessful`, for `copyMarkdown`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
