...
This page explains the overall architecture of `@fairgarden/docs`, including data flows, key design decisions, and how the various pieces fit together.
...
See [workerManager.ts](https://github.com/fairgarden/docs/blob/main/packages/docs/src/pipeline/syncTypes/workerManager.ts) for implementation.
...
| `withFairGardenDocs/`                | Build       | Next.js configuration plugin         |
...
- [withFairGardenDocs](../../pipeline/with-fairgarden-docs/page.mdx) - Next.js configuration
