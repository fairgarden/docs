...
| :------------------------ | :-------- | :------------------- | :---------------------------------------------- |
| `--command`               | `string`  | `pnpm docs validate` | Command to suggest when indexes are out of date |
...
```bash
pnpm docs validate lib/components lib/functions
```
...
```bash
pnpm docs validate --useVisibleDescription
```
...
✗ Generated files are out of date. Run this command locally:
  ...
  pnpm docs validate lib/components
