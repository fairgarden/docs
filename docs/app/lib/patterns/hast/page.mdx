...
HAST is the core data structure used throughout this package for syntax highlighting and markdown processing. Understanding HAST helps you work effectively with FairGarden Docs.
...
```typescript
import { hastToJsx } from '@fairgarden/docs/hastToJsx';
...
HAST is used extensively throughout the FairGarden Docs package:
