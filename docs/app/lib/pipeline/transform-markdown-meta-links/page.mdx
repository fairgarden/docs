...
import transformMarkdownMetaLinks from '@fairgarden/docs/pipeline/transformMarkdownMetaLinks';
...
This plugin is automatically included when using `withFairGardenDocs()` from `@fairgarden/docs`. See the [CodeHighlighter documentation](../../components/code-highlighter/page.mdx#link-to-demo) for examples of Demo components in action.
