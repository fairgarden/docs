...
const nextConfig = {
  turbopack: {
    rules: {
      './app/**/types.ts': {
        loaders: ['@fairgarden/docs/pipeline/loadPrecomputedTypes'],
      },
    },
  },
  webpack: (config, { buildId, dev, isServer, defaultLoaders, webpack }) => {
    config.module.rules.push({
      test: /[/\\\\]app[/\\\\].*[/\\\\]types\.ts$/,
      use: [defaultLoaders.babel, '@fairgarden/docs/pipeline/loadPrecomputedTypes'],
    });
...
- [`withFairGardenDocs`](../with-fairgarden-docs/page.mdx) - Next.js plugin with auto-configuration
