...
```ts
import { loadIsomorphicCodeVariant } from '@fairgarden/docs/pipeline/loadIsomorphicCodeVariant';
...
```ts
import { parseCode } from '@fairgarden/docs/pipeline/loadIsomorphicCodeVariant';
...
```ts
import type { SourceEnhancer, SourceComments } from '@fairgarden/docs/CodeHighlighter/types';
...
```ts
import { flattenCodeVariant } from '@fairgarden/docs/pipeline/loadIsomorphicCodeVariant';
...
```ts
import { maybeCodeInitialData } from '@fairgarden/docs/pipeline/loadIsomorphicCodeVariant';
...
```ts
import { loadCodeFallback } from '@fairgarden/docs/pipeline/loadIsomorphicCodeVariant';
...
```ts
import { applyCodeTransform } from '@fairgarden/docs/pipeline/loadIsomorphicCodeVariant';
...
```ts
import { mergeCodeMetadata } from '@fairgarden/docs/pipeline/loadIsomorphicCodeVariant';
...
```ts
import { examineCodeVariant } from '@fairgarden/docs/pipeline/loadIsomorphicCodeVariant';
...
[`syntax.css`](https://github.com/fairgarden/docs/blob/main/docs/app/lib/components/code-highlighter/demos/syntax.css):
the element animates in at `n * var(--fairgarden-docs-syntax-line-height)` and
