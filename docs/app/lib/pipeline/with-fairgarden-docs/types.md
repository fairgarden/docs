...
[//]: types.ts '<-- Autogenerated By (do not edit the following markdown directly), run: pnpm docs:validate lib/pipeline/with-fairgarden-docs'
...
```tsx
type ReturnValue = FairGardenDocsMdxOptions;
```
...
| Parameter | Type                        | Default | Description |
| :-------- | :-------------------------- | :------ | :---------- |
| options?  | `WithFairGardenDocsOptions` | -       | -           |
...
### WithFairGardenDocsOptions

````typescript
type WithFairGardenDocsOptions = {
  /**
