...
const nextConfig = {
  ...
  webpack: (config, { buildId, dev, isServer, defaultLoaders, webpack }) => {
    config.module.rules.push({
      ...
      use: [defaultLoaders.babel, '@fairgarden/docs/pipeline/loadPrecomputedCodeHighlighterClient'],
    });
...
const externals = {
  ...
  '@base-ui/react/direction-provider': { DirectionProvider, useDirection }, // Named imports as object
  '@base-ui/react/button': { Button }, // Single named import as object
...
- [withFairGardenDocs](../with-fairgarden-docs/page.mdx) - Next.js plugin that configures this loader automatically
