...
import transformMarkdownBlockquoteCallouts from '@fairgarden/docs/pipeline/transformMarkdownBlockquoteCallouts';
...
This plugin is included by default in the FairGarden Docs markdown pipeline. You can also use it in any unified/remark-based project.
