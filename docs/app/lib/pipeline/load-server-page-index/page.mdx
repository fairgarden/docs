...
```ts
import { loadServerPageIndex } from '@fairgarden/docs/pipeline/loadServerPageIndex';

// Load metadata from a markdown file
const pageData = await loadServerPageIndex('file:///path/to/lib/components/page.mdx');

// Returns: { title: 'Lib Components', prefix: '/lib/components/', pages: [...] }
```
...
const data = await loadServerPageIndex('file:///app/lib/functions/page.mdx');

// Returns:
// {
//   title: 'Lib Functions',
//   prefix: '/lib/functions/',
//   pages: [
//     {
...
```ts
import { createLoadServerPageIndex } from '@fairgarden/docs/pipeline/loadServerPageIndex';
...
```ts
import { pathSegmentToTitle } from '@fairgarden/docs/pipeline/loadServerPageIndex';

pathSegmentToTitle('user-helpers'); // 'User Helpers'
...
```ts
import { extractPrefixAndTitle } from '@fairgarden/docs/pipeline/loadServerPageIndex';

extractPrefixAndTitle('/app/lib/components/page.mdx', '/app');
// { prefix: '/lib/components/', title: 'Lib Components' }
