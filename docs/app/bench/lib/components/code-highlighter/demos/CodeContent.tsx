...
import { CodeActionsMenu } from '../../../../../lib/components/code-highlighter/demos/CodeActionsMenu';
import {
  CodeBlockHeader,
  CodeBlockHeaderLabel,
} from '../../../../../lib/components/code-highlighter/demos/CodeBlockHeader';
import { CodeSource } from '../../../../../lib/components/code-highlighter/demos/CodeSource';
