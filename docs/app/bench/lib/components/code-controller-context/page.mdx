...
This demo showcases the performance of the [`CodeControllerContext`](../../../../lib/components/code-controller-context/page.mdx) component when handling large code snippets.
